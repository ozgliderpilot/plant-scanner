...
Volunteers need pending sales/culls/labels pushed and the plant list refreshed without juggling two manual actions. WorkManager’s periodic floor is 15 minutes — too slow for a selling session — and volunteers keep the app open while working.
