 ...
 * scanned [accession] is kept and [name] is "unknown" so it can be reconciled later. Unit price is
 * always keyed at sale (decision #6); discount is a percentage 0..100 (decision #5).
 */
data class LineItem(
    val accession: String,
    val name: String,
